...
class ResponseForm(forms.Form):
    ...
    explanation=forms.CharField(label='Açıklama / mevcut durum',max_length=4000,widget=forms.Textarea(attrs={'rows':3}))
...
class FindingForm(forms.Form):
    action=forms.ChoiceField(choices=[('remediate','Giderim bildir'),('dispute','İtiraz et'),('close','Onayla ve kapat'),('reject','Reddet / açık tut'),('reopen','Yeniden aç')])
